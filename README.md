...
<p align="center">
  <img src="logo_v4.png" alt="Logo" width="800">
</p>
...
## Recommended usage
To use this pipeline, we recommend the following steps after modification basecalling:
1. Map your DORADO uBAM files that contain the modification MM/ML tags to a genome or transcriptome assembly. 
2. Input the mapped reads to a long-read transcriptome reconstruction tool of your choice. You will have to make sure that one of the outputs is the read-to-transcript association file, which should be a tsv (compressed tsv.gz also accepted) with two columns. If the format does not align with what is shown in the "Input" section, please make sure to reformat the file to make it fit.
3. Run [SQANTI3](https://github.com/ConesaLab/SQANTI3) with your generated LR-defined transcriptome
4. Run SQANTI-MOD!
...
```text
--mods MOD [MOD ...]       modifications to analyze (m6A). We recommend using the 
...
Please make sure that you have an index .bai file for your bams and that the isoform ids coincide between the GTF, the association TSV and the SQANTI3 classification file. We recommend 
